...

{
    ...
    <form className='flex flex-col mt-9' style={{ width: "95%" }} onSubmit={formik2.handleSubmit}>
           ...
           <div className={`border-4 w-3/12 rounded-lg flex items-center justify-center  ${activeBank === "Canada" ? " bg-green-200 " :" "} `}><img src={`src/assets/images/bankofcanada.png`} alt="" className=' m-auto ' style={{width:"50%"}}/>   </div>
                        
           <div className={`border-4 w-3/12 rounded-lg flex items-center justify-center ${activeBank === "TD" ? " bg-green-200 " :" "} `}><img src={`src/assets/images/td.png`} alt="" className=' m-auto ' style={{width:"50%"}}/>   </div>
           <div className={`border-4 w-3/12 rounded-lg flex items-center justify-center ${activeBank === "Royal" ? " bg-green-200 " :" "} `}><img src={`src/assets/images/rbc.png`} alt="" className=' m-auto ' style={{width:"50%"}}/>   </div>
           <div className={`border-4 w-3/12 rounded-lg flex items-center justify-center ${activeBank === "Nova" ? " bg-green-200 " :" "} `}><img src={`src/assets/images/scoti.png`} alt="" className=' m-auto ' style={{width:"50%"}}/>   </div>
           <div className={`border-4 w-3/12 rounded-lg flex items-center justify-center ${activeBank === "Montreal" ? " bg-green-200 " :" "} `}><img src={`src/assets/images/m.png`} alt="" className=' m-auto ' style={{width:"50%"}}/>   </div>
